...
for(const file of ['assets/inline-04.js','assets/inline-11.js','assets/inline-12.js','refresh-2026-09-14.js','refresh-2026-09-21.js','turntable-certifications.js'])vm.runInContext(fs.readFileSync(file,'utf8'),c);
